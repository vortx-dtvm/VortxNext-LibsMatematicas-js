...
const Operacoes = require('./OperacoesMath')
const MassaDeTeste = require('./MassaDeTeste')


describe('Deve realizar o calculo da curva Gaussiana utilizando  a lib Math', () => {
...
describe('Deve realizar a lei Snell Descartes utilizando a lib Math', () => {
...
describe('Deve realizar o calculo da divisão de logs utilizando a lib Math', () => {
...
describe('Deve realizar o calculo de Bhaskara utilizando a lib Math', () => {
    ...
    it('Deve calcular o valor da divisão, utilizando valor unitário', () => {
        ...
        //Resultado esperado
        expect(resultado.toFixed(12)).to.be.equal('196.589869219246')
        })
...
describe('Deve realizar o calculo de Juros Simples utilizando a lib Math', () => {
...
describe('Deve realizar o calculo de Juros Compostos utilizando a lib Math', () => {
...
describe('Deve realizar o calculo de Amortização utilizando a lib Math', () => {
...
describe('Deve realizar o calculo de Desvio Padrão utilizando a lib Math', () => {
